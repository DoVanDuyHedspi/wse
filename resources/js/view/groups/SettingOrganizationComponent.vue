        ...
        <el-row :gutter="20">
          <el-col :span="24">
            ...
            >
              ...
              <!-- <el-row :gutter="20">
                <el-col :span="24">
                  <h4>Ngày cuối tuần</h4>
                  <el-divider class="m-0"></el-divider>
                </el-col>
                <el-col :span="24" class="my-3">
                  <el-switch v-model="value1"></el-switch> <b class="ml-3">Thứ 7</b><br>
                  <el-switch v-model="value2" active-color="#13ce66"></el-switch><b class="ml-3">Chủ nhật</b>
                </el-col>
              </el-row> -->
            ...
            >
              ...
              <el-table :data="positions" stripe style="width: 100%">
                ...
                <el-table-column label="Khung thời gian được phép chấm công" width="250">
                  <template slot-scope="scope">
                    <span>
                      {{scope.row.begin_allowed_access}}
                      <i class="el-icon-right"></i>
                      {{scope.row.end_allowed_access}}
                    </span>
                  </template>
                </el-table-column>
                <el-table-column label="Thao tác">
...
export default {
  ...
  methods: {
    ...
    createPosition(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          axios.post("/api/positions", this.form_position).then(response => {
            if (response.data.status === false) {
              this.error.message = response.data.message;
              this.$notify.error({
                title: "Thất bại",
